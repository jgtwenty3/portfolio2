...
const BentoCard = ({ src, title, description, textColor = "text-blue-50" }) => {
    return (
      <div className="relative size-full">
        ...
        <div className="relative z-10 flex size-full flex-col justify-between p-5">
          <div>
            <h1 className={`bento-title special-font ${textColor}`}>{title}</h1>
            {description && (
              <p className={`mt-3 max-w-64 text-md  rounded-lg ${textColor}`}>
                {description}
              </p>
            )}
          </div>
    ...
    return (
      <section className="bg-black pb-52">
        <div className="container mx-auto px-3 md:px-10">
          <div id="tech-stack" className="px-5 py-32">
            ...
            <div className="md:flex flex-row justify-between ">
              <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
                I'm a full stack developer and web designer. I use modern frameworks like NextJs, GSAP, and ThreeJs to weave together amazing web experiences. Whether you need a website redesign or have an idea for a full blown product, I can help.
              </p>
              <br />
              <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
          ...
          <div id="work" className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
            <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
              <a href="https://ltrainskateco.netlify.app/">
                <BentoCard
                  src="videos/ltrainskate.mp4"
                  title={<>L TRAIN sk<b>a</b>te</>}
                  description="Skateboard customizer with GSAP and ThreeJS"
